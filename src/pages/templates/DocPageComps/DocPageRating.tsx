      ...
      return (
         <div className='doc-rating-cmt-container'>
            <div className='doc-rating-container'>
               ...
               <div className='doc-rating-hint'>
                  {typeof this.state.rating === 'undefined'
                     ...
                     : this.state.rating === 0
                        ? (this.props.author ? '“' + this.props.author + ' must be punished for this unacceptable failure!”, said Boss.' : 'Sorry, we will try to improve')
                        : this.state.rating === 1
            ...
            <div className='doc-cmt-container'>
               <TextField multiline resizable={false} placeholder='We value and appreciate receiving your feedback. It will not be made public.' rows={7} value={this.state.textFieldValue} onChange={this.onTextFieldChange} />
